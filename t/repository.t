...
# git_repository_open
is( git_repository_open( $standard_repo,   $NOT_EXISTING_PATH ),         -5, 'git_repository_open: path not exist' );
is( git_repository_open( $standard_repo,   $NOT_REPOSITORY_PATH ),       -7, 'git_repository_open: path not a repo' );
is( git_repository_open( $standard_repo,   $REPOSITORY_PATH ),            0, 'git_repository_open: standard repository' );
is( git_repository_open( $empty_repo,      $EMPTY_REPOSITORY_GIT_DIR ),   0, 'git_repository_open: empty repository' );
is( git_repository_open( $empty_bare_repo, $EMPTY_BARE_REPOSITORY_PATH ), 0, 'git_repository_open: empty bare repository' );
...
is( git_repository_init( $tmp_repo, $bare_tmp_repo_path, 1 ), 0, 'git_repository_init: bare repository' );
...
is( git_repository_init( $tmp_repo, $normal_tmp_repo_path, 0 ), 0, 'git_repository_init: normal repository' );
